...
export type DeploymentExposureUpdate = {
  readonly serviceName: string
  readonly namespace?: string
  readonly exposure: Exposure
  readonly tailscaleOnly: boolean
...
export type DeploymentExposureResponse = {
  readonly deployment: DeploymentExposureUpdate
}
...
export const DeploymentExposureResponse = z.object({
  deployment: z.object({
    serviceName: z.string(),
