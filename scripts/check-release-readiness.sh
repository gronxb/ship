...
require_text docs/guide/installation.md "ship uninstall"
require_text docs/guide/installation.md "CLOUDFLARE_API_TOKEN"
require_text docs/guide/installation.md "SHIP_DASHBOARD_SERVICE"
